...
function boxIt(data) {
    ...
    switch(text[n][1]) {
        case "left":
            ...
            reText[pos] += text[n][0]
            reTextArray = reText[pos].match(/ǆ+/g)
            reText[pos] = reText[pos].replace(/ǆ+/g, "")
            ...
            for(let m = text[n][0].length; m < maxChar; m++) reText[pos] += "ǆ"
        ...
        case "right":
            ...
            for(let m = 0; m < maxChar-text[n][0].length; m++) reText[pos] += "ǆ"
            reText[pos] += text[n][0]
        ...
        case "center":
            ...
            for(let m = 0; m < Math.floor((maxChar-text[n][0].length)/2) ; m++) reText[pos] += "ǆ"
            reText[pos] += text[n][0]
